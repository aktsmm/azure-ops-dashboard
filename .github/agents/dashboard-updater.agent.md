...
tools:
  [agent, edit/editFiles, execute/runInTerminal, todo]
---
...
```
execute/runInTerminal: Get-Date -Format "yyyy-MM-dd"
```
...
- `DASHBOARD.md` が開けない → 処理を中断し理由を報告
- 編集が失敗した → 処理を中断し失敗箇所を報告
