...
- Modified: [i18n.py](azure-ops-dashboard/i18n.py)
...
- Modified: [main.py](azure-ops-dashboard/main.py)
...
- Modified: [ai_reviewer.py](azure-ops-dashboard/ai_reviewer.py)
...
- Modified: [collector.py](azure-ops-dashboard/collector.py)
...
- Modified: [README.md](azure-ops-dashboard/README.md)
